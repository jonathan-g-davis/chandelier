...
use crate::axis::{self, PriceAxis, TimeAxis, ValueAxis};
use crate::render::{PlotLayout, Series};
use crate::scale::{PriceScale, ValueScale};
use crate::series::{CandleSeries, VolumeSeries};
...
///
/// To stack a volume chart beneath a [`CandlestickChart`] with their time axes
/// aligned column-for-column, give the two series the same bar
